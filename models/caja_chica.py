...
class CajaChica(models.Model):
    ...
    def action_open(self):
        ...
        for record in self:
            ...
            record.message_post(
                body=f"Caja Chica {record.name} abierta con monto inicial: {record.initial_amount}",
    ...
    def action_close(self):
        ...
        for record in self:
            ...
            record.message_post(
                body=f"Caja Chica {record.name} cerrada con saldo final: {record.current_balance}",
                message_type='notification'
            )
